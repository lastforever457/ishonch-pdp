...
const Rooms = () => {
  ...
  const { mutate: mutateCreateRoom, isPending: isCreatePending } =
    useCreateRoom();
  const { mutate: mutateUpdateRoom, isPending: isUpdatePending } =
    useUpdateRoom();
  const { mutate: mutateDeleteRoom, isPending: isDeletePending } =
    useDeleteRoom();
  ...
  if (isLoading || isCreatePending || isDeletePending || isUpdatePending)
    return <CustomLoader />;
